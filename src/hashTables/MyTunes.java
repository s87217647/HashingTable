 ...
 *
 * @author Foothill College, Bita M [Ruijie Sheng]
 */
public class MyTunes {
    ...
    private final FHhashQPwFind<Integer, SongCompInt> tableOfSongIDs;
    private final FHhashQPwFind<String, SongsCompGenre> tableOfGenres;

    // List of genres found while populating tableOfGenres field
    private final ArrayList<String> genreNames;
